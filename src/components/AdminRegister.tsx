...
export default function AdminRegister({ onBackToLogin }: AdminRegisterProps) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const registerData: RegisterRequest = {
        ...
        subsidiary: "", // Empty string for unified system
      ...
      if (error instanceof Error) {
        ...
        if (
          ...
          errorMessage =
            "Invalid admin key. Please check your admin key and try again.";
        } else if (
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                🔐 This ensures only authorized personnel can create admin
                accounts
              </p>
            </div>
          </CardContent>
