...
import logo from '../../assets/genomac.png';
...
export default function CertificateTemplate5({
    ...
    isPreview = false,
    organizationName = "Genomac Services and Consults.",
        ...
        >
          <div className="relative w-[1000px] h-[600px] flex overflow-hidden z-10">
            <div className="bg-gradient-to-b from-pink-400 via-purple-900 to-purple-900 w-[200px] h-[600px] flex flex-col">
              ...
              {/* <div className="text-white text-[9px] m-2 p-3 bg-purple-950 rounded-lg text-left mt-44 flex-shrink-0">
              ...
              <div className="text-[8px] m-2 p-3 bg-purple-950 rounded-lg text-left flex-shrink-0 mt-4">
                ...
                <p className="text-white leading-relaxed text-[7px]">
                  Beside Alari Akata Filling Station, Under-G, Ogbomoso, Oyo
                  State, Nigeria
                </p>
              </div> */}
            </div>
