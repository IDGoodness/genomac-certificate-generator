...
export default function CertificateTemplateManager({ subsidiary }: CertificateTemplateManagerProps) {
  ...
  const templates = [
    ...
    },
    {
      ...
      preview: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=300&h=200&fit=crop'
    },
    {
      id: 'minimal',
      name: 'Minimal Clean',
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setCustomFields(prev => ({ ...prev, title: e.target.value }))}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setCustomFields(prev => ({ ...prev, subtitle: e.target.value }))}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setCustomFields(prev => ({ ...prev, footer: e.target.value }))}
                    />
                  </div>
                </CardContent>
              </Card>
